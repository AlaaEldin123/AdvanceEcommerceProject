...
if ($files =$request->file('file')) {
	$destinitaionPath = 'upload/pdf'; // upload path
	$digitalItem = date('YmdHis') . ".".$files->getClientOriginalExtension();
	$files->move($destinitaionPath,$digitalItem);
}
