		...
		<div class="row">
			...
			<div class="col-md-2"><br>
				...
				<ul class="list-group list-group-flush">
					...
					<a href="{{route('user.profile')}}" class="btn btn-primary btn-sm btn-block">Pofile Update</a>
			...
			<div class="col-md-6">
				...
				<div class="card">
					<h3 class="text-center">
						<span class="text-danger">Hii... </span><strong>{{Auth::user()->name}} </strong>Welcome To Easy Online Shope
					</h3>
