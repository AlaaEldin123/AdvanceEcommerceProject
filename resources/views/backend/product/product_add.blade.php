...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Short Discription English" ></textarea>
			...
			<div class="controls">
<textarea name="short_descp_ar" id="textarea" class="form-control" required placeholder="Short Discription Arabic"></textarea>
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
<textarea id="editor1" name="long_descp_en" required="" rows="10" cols="80" placeholder="Long Discription English">
			...
			<div class="controls">
<textarea id="editor2" name="long_descp_ar" required="" rows="10" cols="80" placeholder="Long Discription Arabic">
...
<div class="col-md-4">
				   ...
				   <div class="form-group">
			<h5>Dijital Product <span class="text-danger">pdf,xlx,csv</span></h5>
			<div class="controls">
