  ...
  <!-- get name or route to make condiction to active iot when click on it by sidebar -->
@php
        ...
        <li class="treeview {{($prefix =='/product')?'active':''}}">
         ...
         <li class="treeview {{($prefix =='/slider')?'active':''}}">
          ...
          <ul class="treeview-menu">
             ...
             <li class="{{ ($route == 'manage-product')? 'active':'' }}"><a href="{{ route('manage-slider') }}"><i class="ti-more"></i>Manage Slider</a></li>
         ...
         <li class="treeview {{($prefix =='/setting')?'active':''}}">
          ...
          <ul class="treeview-menu">
             ...
             <li class="{{ ($route == 'site.setting')? 'active':'' }}"><a href="{{ route('site.setting') }}"><i class="ti-more"></i>Site Setting</a></li>
              ...
              <li class="{{ ($route == 'seo.setting')? 'active':'' }}"><a href="{{ route('seo.setting') }}"><i class="ti-more"></i>Site Setting</a></li>
...
<li class="treeview {{($prefix =='/review')?'active':''}}">
    ...
    <li class="treeview {{($prefix =='/orders')?'active':''}}">
          ...
          <ul class="treeview-menu">
             ...
             <li class="{{ ($route == 'manage-orders')? 'active':'' }}"><a href="{{ route('manage-orders') }}"><i class="ti-more"></i>Pending Orders</a></li>
 ...
 <li class="treeview {{($prefix =='/stock')?'active':''}}">
          ...
          <ul class="treeview-menu">
             ...
             <li class="{{ ($route == 'product.stock')? 'active':'' }}"><a href="{{ route('product.stock') }}"><i class="ti-more"></i>Manage Stock</a></li>
