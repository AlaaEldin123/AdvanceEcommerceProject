...
<head>
  <meta charset="utf-8">
    ...
    <title>Eusy Ecommerce Admin - Log in </title>
            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input name="email" type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								  ...
								  <div class="row">
									...
									<div class="col-6">
									 <div class="fog-pwd text-right">
										<a href="j{{ route('password.request') }}" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot pwd?</a><br>
									  </div>
									</div>
									<!-- /.col -->
