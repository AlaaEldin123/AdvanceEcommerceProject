...
@if(session()->get('language') == 'arabic') بروفايل
@else My Account @endif
            ...
            <li><a href="" type="button" data-toggle="modal" data-target="#ordertracking"><i class="icon fa fa-check"></i>Order Tracing</a></li>
...
@if(session()->get('language') == 'arabic') اللغات
@else Language @endif
          ...
          <div class="search-area">
            <form method="post" action="{{route('product.search')}}">
              ...
              <div class="control-group">
                ...
                <input class="search-field" onfocus="search_result_show()" onblur="search_result_hide()" id="search" placeholder="Search here..." / name="search" >
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              ...
              <div class="total-price-basket"> <span class="lbl">cart -</span> <span class="total-price"> <span class="sign">$</span><span class="value" id=""></span> </span> </div>
            </div>
            </a>
            <ul class="dropdown-menu">
              <li>
...
<!-- Start Mini Card Start With Ajax -->
<div id="miniCart">
...
@if(session()->get('language') == 'arabic') الرئيسة
@else Home @endif
                </a> </li>
...
@else {{ $subsubcategory->subsubcategory_name_en }} @endif
  ...
  @endforeach <!-- // End Category Foreach -->  <!-- end category foreach -->
