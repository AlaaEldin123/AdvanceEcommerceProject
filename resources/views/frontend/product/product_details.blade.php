...
<span class="fa fa-star checked"></span>
   @endif
							...
							@if(session()->get('language') == 'arabic') {{$product->short_descp_ar}}
...
<!-- guest that mean the user which doesn't login -->												<!--  -->
@guest
<p><b>For Add Product Review You Need To Login First <a href="{{route('login')}}">From Here</a></b></p>
@else
			...
			<form role="form" class="cnt-form" method="psot" action="{{route('review.store')}}">
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6116d8f471602aa6"></script>
